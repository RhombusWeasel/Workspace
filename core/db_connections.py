...
backend.  Only ``SQLiteProvider`` is shipped — more can be added later.
"""
...
def register_provider(cls: type[DBProvider]) -> type[DBProvider]:
    """Register a DB provider class.  Used as a class decorator or called directly."""
...
# Register the built-in SQLite provider
