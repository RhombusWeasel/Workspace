...
DEFAULT_CHAT_AGENT = {
    ...
    "template": (
        ...
        "Date: {{date}}\n\n"
        "Contents of `~/.agents/user.md`:\n\n"
        "{{user}}\n\n"
        "Contents of `.agents/design.md`:\n\n"
        "{{design}}\n\n"
        ...
        "{{global_agents}}\n\n"
        "Repo specific settings are detailed below, these settings take prescidence over all others as it involves interaction with the users codebase so must be strictly followed.\n\n"
        "{{local_agents}}\n"
    ),
    "model": "",
    "provider": "",
