"""Plugin service factories — maps service names to factory callables.

Each plugin that contributes services to AppContext declares them here.
...
from plugins.database.core.db_connections import ConnectionManager
