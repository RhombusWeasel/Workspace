...
from plugins.chat.stream_section import StreamSection
from plugins.chat.tool_format import format_tool_call_display, format_tool_call_json
...
class ChatManager(Widget):
    ...
    tab's :class:`~plugins.chat.chat_tab.ChatTabState`.  When the
    ...
    async def _rebuild_display_from_sections(self) -> None:
        ...
        from plugins.chat.tool_format import format_tool_call_display
