"""AI chat plugin — streaming conversation in a workspace tab.
...
from plugins.chat.chat_tab import register_chat_leader_chords  # noqa: F401
from plugins.chat.commands import register_chat_commands       # noqa: F401
