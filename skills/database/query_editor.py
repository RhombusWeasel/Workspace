...
from skills.database.core.db_connections import ConnectionInfo, ConnectionManager, QueryResult
...
class QueryEditor(Widget):
    ...
    def on_mount(self) -> None:
        ...
        if self._conn_info:
            from skills.database.core.db_connections import get_provider
