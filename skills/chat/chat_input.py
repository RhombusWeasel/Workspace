...
class ChatInput(Widget):
    ...
    **Enter** submits the message.  **Shift+Enter** inserts a newline
    ...
    def set_palette(self, palette: CommandPalette) -> None:
        """Inject the command palette managed by :class:`~skills.chat.chat_manager.ChatManager`.
    ...
    def set_file_palette(self, file_palette: FilePalette) -> None:
        """Inject the file palette managed by :class:`~skills.chat.chat_manager.ChatManager`.
